...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: any) {
    ...
    return (
        ...
        >
            <motion.div
                variants={{
                    inactive: { scale: 1, backgroundColor: "#18181b", color: "#71717a" },
                    active: { scale: 1, backgroundColor: "#7c3aed", color: "#7c3aed" },
                    complete: { scale: 1, backgroundColor: "#7c3aed", color: "#3b82f6" },
                }}
